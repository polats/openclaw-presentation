...
import {
  SupercellLab0508Presentation,
  SCLAB_0508_SLIDES,
  SCLAB_0508_TOTAL_FRAMES,
  getSCLab0508SlideStarts,
} from '../../components/SupercellLab0508Presentation';
...
const SLIDES = getSCLab0508SlideStarts().map((s) => ({
  name: s.name,
  start: s.start,
  duration: s.duration,
}));
