...
import {
  SupercellLab0429Presentation,
  SCLAB_0429_SLIDES,
  SCLAB_0429_TOTAL_FRAMES,
  getSCLab0429SlideStarts,
} from '../../components/SupercellLab0429Presentation';
...
const SLIDES = getSCLab0429SlideStarts().map((s) => ({
  name: s.name,
  start: s.start,
  duration: s.duration,
}));
